...
Текущий tip схемы: **012_booking_tracking** (`schema_migrations_pg` → `001`…`012`).

Файл: [`nikafit_public_sanitized.sql`](nikafit_public_sanitized.sql) — DDL + seed + отметки миграций `001`–`012`.
