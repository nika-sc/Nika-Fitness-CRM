...
Текущий tip схемы: **019_site_booking_requests** (`schema_migrations_pg` → `001`…`019`).

Файл: [`nikafit_public_sanitized.sql`](nikafit_public_sanitized.sql) — DDL + seed + отметки миграций `001`–`019`.
