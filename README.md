...
- Справочник тренеров и кабинет тренера: свои окна, заявки из ЛК, подтверждение
- Запись на персоналку со стойки, из карточки клиента и из личного кабинета

### Личный кабинет клиента

- Вход по телефону / email / карте
- Цифровой абонемент и **QR-пропуск** для стойки
- Запись на групповые занятия и на персоналку (заявка → подтверждение тренера)
